...
public class FrmThongKeHopDong extends JPanel {
	...
	public FrmThongKeHopDong() {
		...
		JLabel lblNewLabel = new JLabel("THỐNG KÊ \tHỢP ĐỒNG");
		lblNewLabel.setFont(new Font("Times New Roman", Font.BOLD, 15));
		lblNewLabel.setBounds(313, 0, 176, 29);
		add(lblNewLabel);
		...
		table_1.setModel(new DefaultTableModel(
			...
			new String[] {
				"Mã HĐ", "Tên HĐ", "Ngày Lập", "Ngày Giao", "Tổng Tiền"
			}
		));
